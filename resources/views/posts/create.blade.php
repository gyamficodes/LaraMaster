        ...
        <form method="POST" action="/posts" class="space-y-8">
            ...
            <div class="space-y-3">
                ...
                <div class="relative w-full">
                    <x-form-input name="title" type="text" placeholder="Enter a title"
            ...
            <div class="space-y-3">
                ...
                <div class="relative">
                    <textarea name="body" placeholder="Write your message here..."
                        class="w-full px-4 pl-[39px] py-3 rounded-lg border-0   shadow-sm ring-1 ring-gray-300 focus:ring-2 focus:ring-indigo-500 transition-all duration-200 min-h-[150px] max-h-[300px]"></textarea>
