    ...
    <div class="min-h-screen  bg-white py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden p-8">
                <form method="POST" action="/register" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="space-y-5">
                        <div>
                            <x-form-label for="name" class="block text-sm font-medium text-gray-700">Full
                                Name</x-form-label>
                        ...
                        <div>
                            <x-form-label for="email"
                                class="block text-sm font-medium text-gray-700">Email</x-form-label>
                            <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <div>
                            <x-form-label for="password"
                                class="block text-sm font-medium text-gray-700">Password</x-form-label>
                            <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <div>
                            <x-form-label for="password_confirmation"
                                class="block text-sm font-medium text-gray-700">Confirm Password</x-form-label>
                            <div class="mt-1 relative rounded-md shadow-sm">
        ...
        <div class="mr-4">
            <img id="avatar-preview"
                 src="{{ auth()->user()->avatar ?? asset('images/default-image.png') }}"
                 alt="Current avatar"
        ...
        <div class="relative rounded-md shadow-sm flex-1">
            ...
            <label for="avatar" class="cursor-pointer">
                <div
                    class="block w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
                    <span class="truncate">Choose new avatar</span>
                </div>
            </label>
        </div>
    </div>
    <x-error name="avatar" class="mt-1 text-sm text-red-600" />
                    </div>
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <x-button
                            class="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-lg shadow-sm transition duration-200 transform hover:-translate-y-0.5">
                            Register
                        </x-button>
                    </div>
                </form>
            ...
            <div class="mt-8 text-center text-sm text-gray-500">
                <p>By registering, you agree to our <a href="#"
                        class="font-medium text-blue-600 hover:text-blue-500">Terms</a> and <a href="#"
                        class="font-medium text-blue-600 hover:text-blue-500">Privacy Policy</a>.</p>
            </div>
        </div>
    </div>
</x-layoutcomp>